...
|---|---:|---:|---:|---:|---|---|
| rodar_qualificado | `pmesp` | PMESP | alta | 82 | fonte direta falhou ou não trouxe texto suficiente | instituicao=pmesp; modo=qualificado; web=true; forcar=true |
...
| ok | `pcce` | PCCE | baixa | 98 | sem ação necessária |  |
| ok | `pmac` | PMAC | baixa | 98 | sem ação necessária |  |
| ok | `pmam` | PMAM | baixa | 98 | sem ação necessária |  |
| ok | `ppac` | PPAC | baixa | 98 | sem ação necessária |  |
