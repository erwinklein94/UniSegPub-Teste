...
Precisam de modo qualificado: **69**
Precisam de revisão: **41**
OK: **0**
...
|---|---:|---:|---:|---:|---|---|
| rodar_qualificado | `pmesp` | PMESP | alta | 78 | fonte direta falhou ou não trouxe texto suficiente; foi publicado por modo qualificado; recomenda revisão visual | instituicao=pmesp; modo=qualificado; web=true; forcar=true |
| rodar_qualificado | `pmmg` | PMMG | alta | 88 | fonte direta falhou ou não trouxe texto suficiente; foi publicado por modo qualificado; recomenda revisão visual | instituicao=pmmg; modo=qualificado; web=true; forcar=true |
| rodar_qualificado | `pcerj` | PCERJ | alta | 89 | fonte direta falhou ou não trouxe texto suficiente; foi publicado por modo qualificado; recomenda revisão visual | instituicao=pcerj; modo=qualificado; web=true; forcar=true |
| rodar_qualificado | `pcsp` | PCSP | alta | 98 | fonte direta falhou ou não trouxe texto suficiente; foi publicado por modo qualificado; recomenda revisão visual | instituicao=pcsp; modo=qualificado; web=true; forcar=true |
| rodar_qualificado | `pmba` | PMBA | alta | 98 | fonte direta falhou ou não trouxe texto suficiente; foi publicado por modo qualificado; recomenda revisão visual | instituicao=pmba; modo=qualificado; web=true; forcar=true |
...
| rodar_qualificado | `pcto` | PCTO | media | 71 | fonte direta falhou ou não trouxe texto suficiente; score abaixo do mínimo (71); foi publicado por modo qualificado; recomenda revisão visual | instituicao=pcto; modo=qualificado; web=true; forcar=true |
| rodar_qualificado | `ppma` | PPMA | media | 71 | fonte direta falhou ou não trouxe texto suficiente; score abaixo do mínimo (71); foi publicado por modo qualificado; recomenda revisão visual | instituicao=ppma; modo=qualificado; web=true; forcar=true |
...
| rodar_qualificado | `pmma` | PMMA | media | 77 | fonte direta falhou ou não trouxe texto suficiente; score abaixo do mínimo (77); foi publicado por modo qualificado; recomenda revisão visual | instituicao=pmma; modo=qualificado; web=true; forcar=true |
...
| rodar_qualificado | `ppap` | PPAP | media | 77 | fonte direta falhou ou não trouxe texto suficiente; score abaixo do mínimo (77); foi publicado por modo qualificado; recomenda revisão visual | instituicao=ppap; modo=qualificado; web=true; forcar=true |
| rodar_qualificado | `ppba` | PPBA | media | 77 | fonte direta falhou ou não trouxe texto suficiente; score abaixo do mínimo (77); foi publicado por modo qualificado; recomenda revisão visual | instituicao=ppba; modo=qualificado; web=true; forcar=true |
...
| rodar_qualificado | `bmba` | BMBA | media | 85 | fonte direta falhou ou não trouxe texto suficiente; foi publicado por modo qualificado; recomenda revisão visual | instituicao=bmba; modo=qualificado; web=true; forcar=true |
| rodar_qualificado | `bmrs` | BMRS | media | 85 | fonte direta falhou ou não trouxe texto suficiente; foi publicado por modo qualificado; recomenda revisão visual | instituicao=bmrs; modo=qualificado; web=true; forcar=true |
...
| rodar_qualificado | `pmto` | PMTO | media | 85 | fonte direta falhou ou não trouxe texto suficiente; foi publicado por modo qualificado; recomenda revisão visual | instituicao=pmto; modo=qualificado; web=true; forcar=true |
| rodar_qualificado | `bmrn` | BMRN | media | 87 | fonte direta falhou ou não trouxe texto suficiente; foi publicado por modo qualificado; recomenda revisão visual | instituicao=bmrn; modo=qualificado; web=true; forcar=true |
| rodar_qualificado | `pcap` | PCAP | media | 87 | fonte direta falhou ou não trouxe texto suficiente; foi publicado por modo qualificado; recomenda revisão visual | instituicao=pcap; modo=qualificado; web=true; forcar=true |
| rodar_qualificado | `bmap` | CBMAP | media | 89 | fonte direta falhou ou não trouxe texto suficiente; foi publicado por modo qualificado; recomenda revisão visual | instituicao=bmap; modo=qualificado; web=true; forcar=true |
| rodar_qualificado | `pmdf` | PMDF | media | 89 | fonte direta falhou ou não trouxe texto suficiente; foi publicado por modo qualificado; recomenda revisão visual | instituicao=pmdf; modo=qualificado; web=true; forcar=true |
| rodar_qualificado | `pmse` | PMSE | media | 89 | fonte direta falhou ou não trouxe texto suficiente; foi publicado por modo qualificado; recomenda revisão visual | instituicao=pmse; modo=qualificado; web=true; forcar=true |
| rodar_qualificado | `bmsc` | CBMSC | media | 92 | fonte direta falhou ou não trouxe texto suficiente; foi publicado por modo qualificado; recomenda revisão visual | instituicao=bmsc; modo=qualificado; web=true; forcar=true |
| rodar_qualificado | `bmsp` | CBPMESP | media | 92 | fonte direta falhou ou não trouxe texto suficiente; foi publicado por modo qualificado; recomenda revisão visual | instituicao=bmsp; modo=qualificado; web=true; forcar=true |
...
| rodar_qualificado | `pmap` | PMAP | media | 92 | fonte direta falhou ou não trouxe texto suficiente; foi publicado por modo qualificado; recomenda revisão visual | instituicao=pmap; modo=qualificado; web=true; forcar=true |
| rodar_qualificado | `ppal` | PPAL | media | 92 | fonte direta falhou ou não trouxe texto suficiente; foi publicado por modo qualificado; recomenda revisão visual | instituicao=ppal; modo=qualificado; web=true; forcar=true |
| rodar_qualificado | `bmpe` | BMPE | media | 94 | fonte direta falhou ou não trouxe texto suficiente; foi publicado por modo qualificado; recomenda revisão visual | instituicao=bmpe; modo=qualificado; web=true; forcar=true |
| rodar_qualificado | `pcrn` | PCRN | media | 94 | fonte direta falhou ou não trouxe texto suficiente; foi publicado por modo qualificado; recomenda revisão visual | instituicao=pcrn; modo=qualificado; web=true; forcar=true |
| rodar_qualificado | `pcpb` | PCPB | media | 95 | fonte direta falhou ou não trouxe texto suficiente; foi publicado por modo qualificado; recomenda revisão visual | instituicao=pcpb; modo=qualificado; web=true; forcar=true |
...
| rodar_qualificado | `pcpr` | PCPR | media | 96 | fonte direta falhou ou não trouxe texto suficiente; foi publicado por modo qualificado; recomenda revisão visual | instituicao=pcpr; modo=qualificado; web=true; forcar=true |
...
| rodar_qualificado | `pcpa` | PCPA | media | 98 | fonte direta falhou ou não trouxe texto suficiente; foi publicado por modo qualificado; recomenda revisão visual | instituicao=pcpa; modo=qualificado; web=true; forcar=true |
| rodar_qualificado | `pcpe` | PCPE | media | 98 | fonte direta falhou ou não trouxe texto suficiente; foi publicado por modo qualificado; recomenda revisão visual | instituicao=pcpe; modo=qualificado; web=true; forcar=true |
| rodar_qualificado | `pmal` | PMAL | media | 98 | fonte direta falhou ou não trouxe texto suficiente; foi publicado por modo qualificado; recomenda revisão visual | instituicao=pmal; modo=qualificado; web=true; forcar=true |
...
| revisar_rascunho_ou_site | `pcmg` | PCMG | alta | 93 | existe rascunho gerado para revisão; foi publicado por modo qualificado; recomenda revisão visual |  |
...
| revisar_rascunho_ou_site | `ppdf` | PPDF | media | 77 | score abaixo do mínimo (77); foi publicado por modo qualificado; recomenda revisão visual |  |
| revisar_rascunho_ou_site | `bmrr` | BMRR | media | 83 | foi publicado por modo qualificado; recomenda revisão visual |  |
...
| revisar_rascunho_ou_site | `bmpa` | BMPA | media | 85 | foi publicado por modo qualificado; recomenda revisão visual |  |
...
| revisar_rascunho_ou_site | `pmce` | PMCE | media | 87 | foi publicado por modo qualificado; recomenda revisão visual |  |
...
| revisar_rascunho_ou_site | `pcma` | PCMA | media | 89 | foi publicado por modo qualificado; recomenda revisão visual |  |
| revisar_rascunho_ou_site | `ppce` | PPCE | media | 89 | foi publicado por modo qualificado; recomenda revisão visual |  |
| revisar_rascunho_ou_site | `ppes` | PPES | media | 89 | foi publicado por modo qualificado; recomenda revisão visual |  |
| revisar_rascunho_ou_site | `ppgo` | PPGO | media | 89 | foi publicado por modo qualificado; recomenda revisão visual |  |
| revisar_rascunho_ou_site | `pcam` | PCAM | media | 91 | foi publicado por modo qualificado; recomenda revisão visual |  |
| revisar_rascunho_ou_site | `pcrs` | PCRS | media | 91 | existe rascunho gerado para revisão; foi publicado por modo qualificado; recomenda revisão visual |  |
...
| revisar_rascunho_ou_site | `bmce` | BMCE | media | 95 | foi publicado por modo qualificado; recomenda revisão visual |  |
