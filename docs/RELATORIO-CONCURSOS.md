...
Precisam de modo qualificado: **67**
Precisam de revisão: **43**
OK: **0**
...
| rodar_qualificado | `bmrn` | BMRN | media | 89 | fonte direta falhou ou não trouxe texto suficiente; foi publicado por modo qualificado; recomenda revisão visual | instituicao=bmrn; modo=qualificado; web=true; forcar=true |
| rodar_qualificado | `pcrn` | PCRN | media | 89 | fonte direta falhou ou não trouxe texto suficiente; foi publicado por modo qualificado; recomenda revisão visual | instituicao=pcrn; modo=qualificado; web=true; forcar=true |
...
| rodar_qualificado | `bmrs` | BMRS | media | 94 | fonte direta falhou ou não trouxe texto suficiente; foi publicado por modo qualificado; recomenda revisão visual | instituicao=bmrs; modo=qualificado; web=true; forcar=true |
| rodar_qualificado | `pmdf` | PMDF | media | 94 | fonte direta falhou ou não trouxe texto suficiente; foi publicado por modo qualificado; recomenda revisão visual | instituicao=pmdf; modo=qualificado; web=true; forcar=true |
| rodar_qualificado | `pcpe` | PCPE | media | 95 | fonte direta falhou ou não trouxe texto suficiente; foi publicado por modo qualificado; recomenda revisão visual | instituicao=pcpe; modo=qualificado; web=true; forcar=true |
...
| rodar_qualificado | `pcpb` | PCPB | media | 98 | fonte direta falhou ou não trouxe texto suficiente; foi publicado por modo qualificado; recomenda revisão visual | instituicao=pcpb; modo=qualificado; web=true; forcar=true |
...
| revisar_rascunho_ou_site | `pmce` | PMCE | media | 89 | foi publicado por modo qualificado; recomenda revisão visual |  |
| revisar_rascunho_ou_site | `ppce` | PPCE | media | 89 | foi publicado por modo qualificado; recomenda revisão visual |  |
| revisar_rascunho_ou_site | `ppdf` | PPDF | media | 89 | foi publicado por modo qualificado; recomenda revisão visual |  |
