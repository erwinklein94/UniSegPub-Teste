# Relatório de atualização — PMAM — 2026-05-13

Base utilizada: `dossie-pmam-2026-05-13.md`.

## Arquivos atualizados

- `js/ui/header-estados.js` — resumo institucional PMAM atualizado.
- `js/data/parametros-cargos.js` — 18 cargos/faixas da PMAM com remuneração total bruta de tabela.
...
- A PMCE já existente no ZIP base foi preservada.
- Campos sem fonte direta no dossiê seguem com `Dados em breve` no conteúdo aplicado.
- O brasão usa `img/MILITAR/pmam.webp`, já existente no projeto.
